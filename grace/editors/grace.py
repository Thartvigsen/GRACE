...
class GRACEAdapter(torch.nn.Module):
    def __init__(self, config, layer, transpose):
        ...
        self.config = config
        self.num_pert = config["editor"]["num_pert"]
        self.key_id = -1
    ...
    def forward(self, *args):
        ...
        if (self.config["editor"]["val_train"] == "adv") and (self.training):
